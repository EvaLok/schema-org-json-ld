...
- **In-flight agent sessions**: 2 (PR #2397 draft awaiting Copilot iteration on integration test fix; PR #2399 draft awaiting Copilot iteration on rebase + commit-hash fix-refs)
