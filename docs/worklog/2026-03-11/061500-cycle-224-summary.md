...
- **In-flight agent sessions**: 2 — [#1024](https://github.com/EvaLok/schema-org-json-ld/issues/1024) and [#1026](https://github.com/EvaLok/schema-org-json-ld/issues/1026)
