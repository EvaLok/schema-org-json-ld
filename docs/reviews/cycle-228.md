...
- The `Commit receipts` table lists `8e4856f`, `86fd387`, and `7520cec` (`docs/worklog/2026-03-11/163009-cycle-228-review-consumption-and-pr-merge-cycle.md:42-48`), but the canonical receipt tool says cycle 228's receipt set is `0ebae88` and `3fafdd7` (`bash tools/cycle-receipts --cycle 228` after fetching full history).
- The just-merged prevention tool agrees the worklog is wrong: `bash tools/validate-docs worklog --file docs/worklog/2026-03-11/163009-cycle-228-review-consumption-and-pr-merge-cycle.md --cycle 228 --repo-root /home/runner/work/schema-org-json-ld/schema-org-json-ld` exits 1 with `commit receipts section is missing required receipt(s): 0ebae88, 3fafdd7`.
