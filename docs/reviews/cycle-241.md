...
- With cycle 241 still in `close_out` and the cycle 241 docs present, both real tools hang instead of returning: `timeout 20s bash tools/pipeline-check --repo-root . --cycle 241 --json` exited `124`, and `timeout 20s bash tools/validate-docs worklog --file docs/worklog/2026-03-13/043505-cycle-241-close-out-resume-review-merge-doc-validation-merge-audit-processing.md --cycle 241 --repo-root .` also exited `124`.
