...
**File**: /home/runner/work/schema-org-json-ld/schema-org-json-ld/docs/worklog/2026-03-28/044944-cycle-389-review-processed-metrics-removal-redispatched.md:25-36
**Evidence**: The published worklog now reports `In-flight agent sessions: 4`, `Copilot metrics: 620 dispatches`, and a next step for `#1889`. But the canonical cycle-complete receipt for cycle 389 is `6b10ddb state(cycle-complete): ... 1 dispatch, 1 merge. [cycle 389]`, and the state snapshot at that commit still has `copilot_metrics.in_flight = 3`, `copilot_metrics.total_dispatches = 619`, and no `#1889` session. The drift was introduced one second later by `6aa2c63 docs(worklog): refresh cycle 389 state after review dispatch [cycle 389]`, which rewrote the state block after `895a0f33 state(record-dispatch): #1889 dispatched [cycle 389]`. Re-running the canonical validator confirms the artifact is now invalid: `bash tools/validate-docs worklog --file docs/worklog/2026-03-28/044944-cycle-389-review-processed-metrics-removal-redispatched.md --cycle 389` fails with `in-flight agent sessions mismatch: worklog reports 4, state.json has 3`.
...
**File**: /home/runner/work/schema-org-json-ld/schema-org-json-ld/docs/journal/2026-03-28.md:86-91
...
## 3. [review-consumption] Cycle 389 claims the prior journal-quality finding was actioned, but the final journal repeats the same same-cycle-dispatch omission

**File**: /home/runner/work/schema-org-json-ld/schema-org-json-ld/docs/journal/2026-03-28.md:97-107
