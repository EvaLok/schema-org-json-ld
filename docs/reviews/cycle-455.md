...
- The regression is codified in the new test at `close_out.rs:2698-2706`, which asserts that the frozen worklog must contain only `PASS (1 warning)` and explicitly must not contain the original `FAIL` line.
