...
| **super-step-out-of-order** | Boundary tool refuses transition (reconciler→executor without going through planner) | Hard error; abort cycle without state mutation; runner exits non-zero |
